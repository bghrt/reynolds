...
<div id="right_box">
      <div class="breadcrumb"> 
   	  <a href="http://www.Reynolds.edu/">Reynolds Home</a> &gt; <a href="../../../../default.htm">Library Home</a> &gt; <a href="../../default.htm">Forms</a> &gt; PRC Instruction Request</div> 
      <!-- ends breadcrumb -->
      ...
      <div id="right_box_wrapper">
	    ...
	    <h2>Library Instruction Request (Parham Road Campus): Form 47- 001A</h2>
        <ol class="indent">
				  ...
				  <li>If you have any questions, call the Reference Desk at 523-5329 (Parham).</li>
              </ol>
        <p>Please fill out the form below. <span class="required">Items marked with an asterisk (*) are required.</span></p>
        <form action="sent.asp" method="post" name="PRCinstruction" id="PRCinstruction"> 
	    	  <fieldset>
                ...
                <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span><br /><br/>
                        ...
                        <legend>Course Information</legend>
                          ...
                          <span class="small_text"> Note: We have 25 computer workstations available</span>.<br/><br/>
                          ...
                          Email: <a href="emailto:dwoetzel@reynolds.edu">dwoetzel@reynolds.edu</a> - OR - Call: 523-5329. <br/></p>
...
-->
                         ...
                         <br/><br/>
                          ...
                          <p>Library instruction will be conducted in the electronic classroom (103J) inside the Parham Library in LTC unless we notify you differently. If your class already meets in a computer lab classroom and you would like the librarian to conduct the session 
                            in this room, please give the room number: 
                  ...
                  <fieldset>
                    ...
                    <p>You can also send an email with the attached assignment to: <a href="emailto:dwoetzel@reynolds.edu">dwoetzel@reynolds.edu</a>.</p>
                    <p>
                ...
                <a href="http://libguides.Reynolds.edu/research" target="_blank">Guide to Research at Reynolds Library</a> for the handouts and worksheets.</p><br/>
...
•	Why sources should be cited</li><li>
•	Types of plagiarism</li><li>
              ...
              (50 Minutes)</div>
                    ...
                    <div id="pone" class="pkgselectbody">
                      <br/>
                        ...
                        <input name="package" type="radio" id="pkg1" value="Package 1" checked="checked" />
                      <br/><br/>
...
<!-- #BeginDate format:Am1 -->December 3, 2013<!-- #EndDate -->
    	</span>
  		<script type="text/javascript">
<!--
var sprytextfield2 = new Spry.Widget.ValidationTextField("Name", "none");
var sprytextfield4 = new Spry.Widget.ValidationTextField("Email", "email", {validateOn:["blur", "change"]});
var sprytextfield1 = new Spry.Widget.ValidationTextField("phoneno", "none");
