  ...
  <!-- For some reason IE6 won't display the contents w/o something here. So I'm using a 1x1 pixel graphic. -->
	<img src="../../../images/1x1.gif" alt="" />
        ...
        <div class="breadcrumb"> 
   	    	<a href="http://www.Reynolds.edu/">Reynolds Home</a> &gt; <a href="../../../../default.htm">Library Home</a> &gt; <a href="../../default.htm">Forms</a> &gt; <a href="default.asp">Western  Instruction Request Form</a> &gt; Message Sent</div> 
        <!-- ends breadcrumb -->
         ...
         <div id="right_box_wrapper">
           ...
           <%
				...
				cdoMessage.To="mhady@reynolds.edu"
				'cdoMessage.To="ahartman@reynolds.edu"
				cdoMessage.Subject="Goochland Instruction Request"
  ...
  <!-- ends footer -->
	<div id="updated">
		<span class="small_text">Last Updated:
              <!-- #BeginDate format:Am1 -->November 4, 2013<!-- #EndDate -->
