  ...
  <!-- For some reason IE6 won't display the contents w/o something here. So I'm using a 1x1 pixel graphic. -->
	<img src="../../images/1x1.gif" alt="" />
        ...
        <div class="breadcrumb"> 
   	    	<a href="http://www.Reynolds.edu/">Reynolds Home</a> &gt; <a href="../../../default.htm">Library Home</a> &gt; <a href="../default.htm">Forms</a> &gt; <a href="default.asp">Assignment Alert</a> &gt; Message Sent</div> 
        <!-- ends breadcrumb -->
         ...
         <div id="right_box_wrapper">
           ...
           <%
				...
				cdoMessage.Subject="Assignment Alert"
				cdoMessage.TextBody="Instructor Information" & vbCrLf & vbCrLf & "Name:" & Request.Form("Name") & vbCrLf & "Email Address:" & Request.Form("Email") & vbCrLf & "Phone:" & Request.Form("Phone") & vbCrLf & "Campus:" & Request.Form("campus") & vbCrLf & vbCrLf & "Assignment Information" & vbCrLf & vbCrLf & "Course Name:" & Request.Form("CourseName")  & vbCrLf& "Number of Students:" & Request.Form("CourseNumber")  & vbCrLf & "Date Assigned:" & Request.Form("dateassigned")  & vbCrLf& "Date Due:" & Request.Form("datedue")  & vbCrLf & "Assignment Description:" & vbCrLf & vbCrLf & Request.Form("description")  & vbCrLf  & vbCrLf & "Several students have same topic?:"  & vbCrLf & Request.Form("sametopic")  & vbCrLf & vbCrLf & "Specific items required:" & vbCrLf & Request.Form("samebooks") & vbCrLf & vbCrLf & "List of Required Materials:" & Request.Form("booklist") & vbCrLf
				cdoMessage.Send
           ...
           <h2>Message Sent</h2>
                <p>Your Assignment Alert  has been sent. If we have any questions or concerns, we will contact you; in the meantime, if you need to contact us, please <a href="../../../research/ask/default.htm">ask a librarian</a>. </p>   
