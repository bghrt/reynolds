  ...
  <!-- For some reason IE6 won't display the contents w/o something here. So I'm using a 1x1 pixel graphic. -->
	<img src="../../images/1x1.gif" alt="" />
        ...
        <div class="breadcrumb"> 
   	    	<a href="http://www.Reynolds.edu/">Reynolds Home</a> &gt; <a href="../../../default.htm">Library Home</a> &gt; <a href="../default.htm">Forms</a> &gt; <a href="default.asp">Room 103J Reservation</a> &gt; Message Sent</div> 
        <!-- ends breadcrumb -->
         ...
         <div id="right_box_wrapper">
           ...
           <%
				...
				cdoMessage.Subject="Room 103J Reservation"
				cdoMessage.TextBody="Instructor Information" & vbCrLf & vbCrLf & "Name:" & Request.Form("Name") & vbCrLf & "Email:" & Request.Form("Email") & vbCrLf & "Phone:" & Request.Form("Phone") & vbCrLf & vbCrLf & "Class Information" & vbCrLf & vbCrLf & "Name of Class:" & Request.Form("classname") & vbCrLf & "Size of Class:" & Request.Form("classsize") & vbCrLf & vbCrLf & "Room Information" & vbCrLf & vbCrLf & "Date:" & Request.Form("date") & vbCrLf & "Time:" & Request.Form("time")& vbCrLf & "Asked Bill First?" & Request.Form("route") & vbCrLf & "Other Information:" & Request.Form("other")
				cdoMessage.Send
           ...
           <h2>Reservation Sent</h2>
                <p>Your room reservation request has been sent. You will receive a confirmation email from library staff within two work days.</p>   
  ...
  <!-- ends footer -->
	<div id="updated">
		<span class="small_text">Last Updated:
              <!-- #BeginDate format:Am1 -->August 21, 2013<!-- #EndDate -->
