...
<div id="right_box">
      ...
      <div id="right_box_wrapper">
		  ...
		  <h2> Library Electronic Classrooms Reserve Request <span class="selectRequiredState">(DTC Room 212 and PRC Room 103J</span>)</h2>
<p>Downtown and Parham Road Campus libraries have electronic  classrooms with 25 computers reserved for library instruction and workshops.  When not in use, the rooms can be reserved by  faculty for non-library related instruction if no computer classroom or lab is  available. </p>
        ...
        <p class="indent">2 . If no regular lab is available, check <a href="http://inside.Reynolds.edu:8086/LRC/downtown">Room 212</a> calendar   to determine if it is available for the  date <span class="marginleft">and time of your class</span>.</p>
