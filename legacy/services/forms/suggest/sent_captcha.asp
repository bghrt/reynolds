  ...
  <!-- For some reason IE6 won't display the contents w/o something here. So I'm using a 1x1 pixel graphic. -->
	<img src="../../images/1x1.gif" alt="" />
        ...
        <div class="breadcrumb"> 
   	    	<a href="http://www.Reynolds.edu/">Reynolds Home</a> &gt; <a href="../../../default.htm">Library Home</a> &gt; <a href="../default.htm">Forms</a> &gt; <a href="default.asp">Suggest a Purchase</a> &gt; Message Sent</div> 
        <!-- ends breadcrumb -->
         ...
         <div id="right_box_wrapper">
           ...
           <h2>Error Occurred</h2>
            ...
            <%
				...
				cdoMessage.TextBody="Requester Information" & vbCrLf & vbCrLf & "Name:" & Request.Form("Name") & vbCrLf & "Email:" & Request.Form("Email") & vbCrLf & "Phone:" & Request.Form("Phone") & vbCrLf & "Emplid:" & Request.Form("Emplid") & vbCrLf & "Affiliation:" & Request.Form("affiliation") & vbCrLf & vbCrLf & "Item Requested" & vbCrLf & vbCrLf & "Item Type:" & Request.Form("itype") & vbCrLf & "Author/Editor:" & Request.Form("Author")  & vbCrLf& "Title:" & Request.Form("Title")  & vbCrLf & "Publisher:" & Request.Form("Publisher")  & vbCrLf& "Date:" & Request.Form("Date")  & vbCrLf & "ISBN:" & Request.Form("ISBN")  & vbCrLf & "Other Info:"  & vbCrLf & Request.Form("Other")  & vbCrLf & vbCrLf & "Reason for Purchase:" & Request.Form("Reason")
				cdoMessage.Send
