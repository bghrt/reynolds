...
<!-- InstanceBeginEditable name="body" -->
      <div id="right_box">
        ...
        &gt; <a href="../default.htm">Forms</a> &gt; Make a Suggestion</div> 
        <!-- ends breadcrumb -->
               
        <div id="right_box_wrapper">
        	<a name="content-jump" id="content-jump" href="#"></a>
  			<h2>Make a Suggestion</h2>
                <p>In order to achieve our goal of providing the highest  quality of service to the students, faculty, and staff of Reynolds, we'd  like to hear your comments about your experience at Reynolds Library and  welcome your suggestions.</p>
            
				<form action="sent.asp" method="post" name="make_suggest" id="make_suggest"> 
						<fieldset>
                            <legend>Your Information - Optional</legend> 
                            <p>If you wish, please identify yourself so that we may follow up with you if necessary. <span class="bold">Providing this information is optional.</span></p>
                        ...
                        <fieldset>
                          ...
                          <label for="comments">Please use this area to express your comments.</label>
                          <br/>
...
<!-- #BeginDate format:Am1 -->October 11, 2013<!-- #EndDate -->
   	</span>
