...
<div id="body_main">
  ...
  <div id="right_box">
        <div class="breadcrumb"> 
   	    	<a href="http://www.Reynolds.edu/">Reynolds Home</a> &gt; <a href="../../../default.htm">Library Home</a> &gt; <a href="../default.htm">Forms</a> &gt; <a href="default.asp">Make A Suggestion</a> &gt; Message Sent</div> 
        <!-- ends breadcrumb -->
         ...
         <div id="right_box_wrapper">
            ...
            <%
				...
				cdoMessage.From="library@jsr.vccs.edu"
				cdoMessage.To="library@jsr.vccs.edu"
				'cdoMessage.To="ahartman@reynolds.edu"
				cdoMessage.Subject="Make A Suggestion"
				cdoMessage.TextBody="Suggester Information" & vbCrLf & vbCrLf & "Name:" & Request.Form("Name") & vbCrLf & "Email:" & Request.Form("Email") & vbCrLf & "Phone:" & Request.Form("Phone") & vbCrLf & "Affiliation:" & Request.Form("affiliation") & vbCrLf & vbCrLf & "Comments:" & Request.Form("Comments")
				cdoMessage.Send
           ...
           <h2>Message Sent</h2>
                <p>Thank you for submitting your suggestion. If you provided your contact information for follow-up, someone will contact you within a couple business days.</p>   
