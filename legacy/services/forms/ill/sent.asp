  ...
  <!-- For some reason IE6 won't display the contents w/o something here. So I'm using a 1x1 pixel graphic. -->
	<img src="../../images/1x1.gif" alt="" />
        ...
        <div class="breadcrumb"> 
   	    	<a href="http://www.Reynolds.edu/">Reynolds Home</a> &gt; <a href="../../../default.htm">Library Home</a> &gt; <a href="../default.htm">Forms</a> &gt; <a href="default.asp">Interlibrary Loan</a> &gt; Message Sent</div> 
        <!-- ends breadcrumb -->
         ...
         <div id="right_box_wrapper">
           ...
           <%
				...
				cdoMessage.To="lrcill@jsr.vccs.edu"
				cdoMessage.Subject="Interlibrary Loan Request"
				cdoMessage.TextBody="Borrower Information" & vbCrLf & vbCrLf & "Name:" & Request.Form("Name") & vbCrLf & "Address:" & Request.Form("Address") & vbCrLf & "Email:" & Request.Form("Email") & vbCrLf & "Phone:" & Request.Form("Phone") & vbCrLf & "Emplid:" & Request.Form("Emplid") & vbCrLf & "Affiliation:" & Request.Form("affiliation") & vbCrLf & "Pick Up Location:" & Request.Form("pickup") & vbCrLf & "Max Cost:" & Request.Form("mcost") & vbCrLf & vbCrLf & "Book Information" & vbCrLf & vbCrLf & "Author/Editor:" & Request.Form("Author")  & vbCrLf& "Title:" & Request.Form("Title")  & vbCrLf & "Publisher:" & Request.Form("Publisher")  & vbCrLf& "Date:" & Request.Form("Date")  & vbCrLf & "ISBN:" & Request.Form("ISBN")  & vbCrLf & "Other Info:"  & vbCrLf & Request.Form("Other")  & vbCrLf & vbCrLf & "Article Information:" & vbCrLf & vbCrLf & "Periodical Title:" & Request.Form("PeriodicalTitle") & vbCrLf & "Article Title:" & Request.Form("ArticleTitle") & vbCrLf & "Article Author:" & Request.Form("ArticleAuthor") & vbCrLf & "ISSN:" & Request.Form("ISSN") & vbCrLf & "Volume:" & Request.Form("Volume") & vbCrLf & "Issue:" & Request.Form("Issue") & vbCrLf & "ArticleDate:" & Request.Form("articledate") & vbCrLf & "Pages:" & Request.Form("Page") & vbCrLf & "Citation Source:" & Request.Form("Source")
				cdoMessage.Send
           ...
           <h2>Request Sent</h2>
                <p>Your interlibrary loan request has been sent. Remember, we ask that you allow a minimum of 2 days for journal articles and a minimum of 5 days for other resources. </p>   
  ...
  <!-- ends footer -->
	<div id="updated">
		<span class="small_text">Last Updated:
              <!-- #BeginDate format:Am1 -->January 28, 2014<!-- #EndDate -->
