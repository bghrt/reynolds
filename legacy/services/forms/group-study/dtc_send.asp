        ...
        <!-- ends breadcrumb -->
         ...
         <div id="right_box_wrapper">
           ...
           <%
				...
				cdoMessage.To="amandahartman@gmail.com"
				cdoMessage.Subject="Group Study Reservation"
				cdoMessage.TextBody="Patron Information" & vbCrLf & vbCrLf & "Name:" & Request.Form("Name") & vbCrLf & "Email:" & Request.Form("Email") & vbCrLf & "Phone:" & Request.Form("Phone") & vbCrLf & "Emplid:" & Request.Form("Emplid") & vbCrLf & "Campus:" & Request.Form("campus")& vbCrLf & "Affiliation:" & Request.Form("affiliation") & vbCrLf & vbCrLf & "Room Information" & vbCrLf & vbCrLf & "Date:" & Request.Form("date") & vbCrLf & "Time:" & Request.Form("time") & vbCrLf & "Number of People:" & Request.Form("PartyNo") & "Special Requests" & Request.Form("special")
				cdoMessage.Send
           ...
           <h2>Reservation Sent</h2>
                <p>Your study room reservation request has been sent. Please come to the Information Desk to get your room at your reserved time.</p>   
                <% End If %>
  ...
  <!-- ends footer -->
	<div id="updated">
		<span class="small_text">Last Updated:
              <!-- #BeginDate format:Am1 -->August 20, 2012<!-- #EndDate -->
