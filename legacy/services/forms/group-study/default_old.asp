        ...
        <div id="right_box_wrapper">
        	<a name="content-jump" id="content-jump" href="#"></a>
  			<h2>Group Study Rooms</h2>
                <p>The Library Technology Center on the <strong>Parham Road Campus</strong> has eight group study rooms, each of
...
<!--                           <label for="datetime" class="required">*Date and time you need the room:</label>
                           ...
                           <span class="textfieldRequiredMsg">A value is required.</span></span><span class="small_text">(Example: 9/5/08, 3-5:00 pm)</span> <br/><br/>
-->                           
...
<!-- #BeginDate format:Am1 -->January 2, 2013<!-- #EndDate -->
   	</span>
        <script type="text/javascript">
<!--
