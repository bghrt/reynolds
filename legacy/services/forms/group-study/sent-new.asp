        ...
        <!-- ends breadcrumb -->
         ...
         <div id="right_box_wrapper">
           ...
           <%
				...
				cdoMessage.To=Request.Form("campus")
				'cdoMessage.To="ahartman@reynolds.edu"
				cdoMessage.Subject="Group Study Reservation"
				cdoMessage.TextBody="Patron Information" & vbCrLf & vbCrLf & "Name: " & Request.Form("Name") & vbCrLf & "Email: " & Request.Form("Email") & vbCrLf & "Phone: " & Request.Form("Phone") & vbCrLf & "Affiliation: " & Request.Form("affiliation") & vbCrLf & vbCrLf & "Room Information" & vbCrLf & vbCrLf & "Date: " & Request.Form("date") & vbCrLf & "Time: " & Request.Form("time") & vbCrLf & "Number of People: " & Request.Form("PartyNo") & vbCrLf & "Special Requests: " & Request.Form("special")
				cdoMessage.Send
