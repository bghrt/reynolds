        ...
        <div id="right_box_wrapper">
        	<a name="content-jump" id="content-jump" href="#"></a>
  			<h2>Group Study Rooms</h2>
                <p>The <strong>Downtown Campus</strong> has three group study rooms and the <strong>Parham Road Campus</strong> has eight group study rooms, each of
             	which can accommodate four to six people. All study rooms are equipped with wireless Internet access, white
                boards, and wall-mounted flat-panel display screens.  College faculty, staff and students are welcome to use 
                the study rooms for academic and college-related activities, such as collaborative learning projects, 
                small meetings, advising or tutoring sessions, etc. Please read the <a href="GSRPolicy-2012.docx">Group Study Room Policy</a> (.DOC) before you make a reservation. Thank you.</p>
          <p>A Study Room can be reserved with any <strong><span class="required">ONE</span></strong> of the following three methods. 
                  Please come to the desk to get your room at your reserved time.</p>
                <ol>
                  <li>Call the Library Circulation Desk: Downtown  523-5211 or Parham Road 523-5220</li>
                  <li>Walk in and reserve at the Circulation Desk</li>
                ...
                <form action="sent.asp" method="post" name="group-study" id="group-study"> 
					<fieldset>
                        ...
                        <legend>Room Information</legend>			
                          ...
                          <label for="campus" class="required">*Campus:</label> 
                           <select name="campus" id="campus">
                   		     <option value="libdtc@reynolds.edu">Downtown</option>
                           	 <option value="libprc@reynolds.edu">Parham Road</option>
                   		  </select>  
                   		  <br/>
                          <label for="date" class="required">*Date you need the room:</label><script>DateInput('date', true)</script> <br/>
                           ...
                           <label for="PartyNo">Number of people in your group:</label> 
                            ...
                            <p class="small_text">Note: Reservations can be made for groups of two or more people for 
                                a two-hour period with possible renewals at the desk</p>
                                
                          <label for="special">Special Requests</label><br/>
                          	<textarea name="special" id="special" cols="45" rows="4"></textarea>
...
<!-- #BeginDate format:Am1 -->September 4, 2012<!-- #EndDate -->
   	</span>
        <script type="text/javascript">
<!--
