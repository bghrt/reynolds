...
<div id="body_main">
  ...
  <div id="right_box">
        <div class="breadcrumb"> 
   	    	<a href="http://www.Reynolds.edu/">Reynolds Home</a> &gt; <a href="../../../default.htm">Library Home</a> &gt; <a href="../default.htm">Forms</a> &gt; <a href="default.asp">Video Request</a> &gt; Message Sent</div> 
        <!-- ends breadcrumb -->
         ...
         <div id="right_box_wrapper">
            ...
            <%
				...
				'cdoMessage.="mhanlin@reynolds.edu"
				cdoMessage.Subject="Suggest a Purchase"
				cdoMessage.TextBody="Requester Information" & vbCrLf & vbCrLf & "Name:" & Request.Form("Name") & vbCrLf & "Email:" & Request.Form("Email") & vbCrLf & "Phone:" & Request.Form("Phone") & vbCrLf & "ClassName" & Request.Form("ClassName") & vbCrLf & "Affiliation:" & Request.Form("affiliation") & vbCrLf & vbCrLf & "Item Requested" & vbCrLf & vbCrLf & "Need Video to" & Request.Form("itype") & vbCrLf & "Format Type" & Request.Form("format")  & vbCrLf& "Title:" & Request.Form("Title")  & vbCrLf & "Director" & Request.Form("Director")  & vbCrLf& "semester" & Request.Form("semester")  & vbCrLf & "To" & Request.Form("To")  & vbCrLf & vbCrLf & "Addional Comments" & Request.Form("Reason")
				cdoMessage.Send
           ...
           <h2>Message Sent</h2>
                <p>Thank you for submitting a request. You should receive an email from a Reynold's librarian within two to three business days. If you have additional questions, please email Mary Hanlin, at: <a href="mailto:mhanlin@reynolds.edu">mhanlin@reynolds.edu</a></p>   
  ...
  <!-- ends footer -->
	<div id="updated">
		<span class="small_text">Last Updated:
              <!-- #BeginDate format:Am1 -->April 3, 2014<!-- #EndDate -->
