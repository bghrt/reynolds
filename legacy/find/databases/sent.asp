...
<div id="body_main">
	<div id="left_box_sub">
            ...
            <div class="sub_box_blue">
                ...
                <div class="sub_box_tabs">
                    ...
                    <ul>
                        <li><a href="http://vccslinc.vccs.edu/F/?func=find-b-0&amp;local_base=Reynolds">Catalog for Books/Video</a></li>
                      	<li><a href="subject.htm">Databases by Subject</a></li>
                ...
                <div class="sub_box_tabs">
                    ...
                    <ul>
                      <li><a href="../../events/pdo/default.asp">Ask a Librarian</a></li>
                      <li><a href="../../events/cite/default.html">Citing Sources</a></li>
                      <li><a href="../../events/guide/default.html">Research Guides</a></li>
                      <li><a href="../../events/faq/default.html">F.A.Qs</a></li>
                  	</ul>
              </div>
  ...
  <div id="right_box">
        <div class="breadcrumb"> 
   	    	<a href="http://www.Reynolds.edu/">Reynolds Home</a> &gt; <a href="../../default.htm">Library Home</a> &gt; &gt; <a href="subject.htm">Databases</a> &gt; <a href="trial.asp">Trial Databases</a> &gt; Suggestions Sent</div> 
<!-- ends breadcrumb -->
         ...
         <div id="right_box_wrapper">
           ...
           <%
				...
				cdoMessage.From="library@reynolds.edu"
				cdoMessage.To="library@reynolds.edu"
				'cdoMessage.To="ahartman@reynolds.edu"
				cdoMessage.Subject="Trial Database Feedback"
				cdoMessage.TextBody="Databases Selected:" & vbCrLf & vbCrLf & Request.Form("db1") & vbCrLf & Request.Form("db2") & vbCrLf & Request.Form("db3") & vbCrLf & Request.Form("db4")  & vbCrLf & Request.Form("db5")  & vbCrLf & Request.Form("db6") & vbCrLf & Request.Form("db7")& vbCrLf & Request.Form("db8")& vbCrLf & vbCrLf & Request.Form("db9")& vbCrLf & vbCrLf & "Comments:" & Request.Form("comments")
				cdoMessage.Send
           ...
           <h2>Suggestions Sent</h2>
                <p>Your trial database suggestion has been sent. Thank you for your input.</p>   
  ...
  <!-- ends footer -->
	<div id="updated">
		<span class="small_text">Last Updated:
              <!-- #BeginDate format:Am1 -->November 9, 2010<!-- #EndDate -->
