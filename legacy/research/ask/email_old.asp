        ...
        <div id="right_box_wrapper">
        	<a name="content-jump" id="content-jump" href="#"></a>
  			<h2>Email a Librarian</h2>
				...
				<form action="sent.asp" method="post" name="ask" id="ask"> 
					<fieldset>
                            ...
                            <h4>Affiliation</h4>
                                ...
                                <div class="tickybox">
                                  <ul>
                                    ...
                                    <li>
                                        <label for="parham">Parham</label> 
                                        Road
                                        <input type="checkbox" name="campus" value="Parham" id="parham" />
                                    </li>
                                    <li>
...
<!-- #BeginDate format:Am1 -->August 5, 2011<!-- #EndDate -->
   	</span>
