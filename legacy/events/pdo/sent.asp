...
<div id="body_main">
	<div id="left_box_sub">
            ...
            <div class="sub_box_blue">
                ...
                <div class="sub_box_tabs">
                    ...
                    <ul>
                      <li><a href="default.asp">Ask a Librarian</a></li>
  ...
  <div id="right_box">
        <div class="breadcrumb"> 
   	    	<a href="http://www.Reynolds.edu/">Reynolds Home</a> &gt; <a href="../../default.htm">Library Home</a> &gt; <a href="default.asp">PDO Catalog</a> &gt; Message Sent</div> 
<!-- ends breadcrumb -->
         ...
         <div id="right_box_wrapper">
           ...
           <%
				...
				cdoMessage.Subject="PDO Requests"
				cdoMessage.TextBody="PDO Requests:" & vbCrLf & vbCrLf & Request.Form("pdo") 
				cdoMessage.Send
           ...
           <h2>Email Sent</h2>
                <p>Your PDO requests have been sent. Thank you for your input.</p>   
  ...
  <!-- ends footer -->
	<div id="updated">
		<span class="small_text">Last Updated:
              <!-- #BeginDate format:Am1 -->July 2, 2009<!-- #EndDate -->
