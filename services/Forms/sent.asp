  ...
  <!-- For some reason IE6 won't display the contents w/o something here. So I'm using a 1x1 pixel graphic. -->
	<img src="../../../images/1x1.gif" alt="" />
        ...
        <div class="breadcrumb"> 
   	    	<a href="http://www.Reynolds.edu/">Reynolds Home</a> &gt; <a href="../../../../default.htm">Library Home</a> &gt; <a href="../../default.htm">Forms</a> &gt; <a href="default.asp">Downtown  Instruction Request Form</a> &gt; Message Sent</div> 
        <!-- ends breadcrumb -->
         ...
         <div id="right_box_wrapper">
           ...
           <%
				...
				cdoMessage.To="mhanlin@reynolds.edu"
				'cdoMessage.To="mhanlin@renolds.edu"
				cdoMessage.Subject="DTC Instruction Request"
				cdoMessage.TextBody="Instructor Information" & vbCrLf & vbCrLf & "Name: " & Request.Form("Name") & vbCrLf & "Email: " & Request.Form("Email") & vbCrLf & "Phone: " & Request.Form("Phone") & vbCrLf & vbCrLf & "Class Information" & vbCrLf & vbCrLf & "Name of Class: " & Request.Form("classname") & vbCrLf & "Size of Class: " & Request.Form("classsize") & vbCrLf & "Instructor Attendance: " & Request.Form("attend") & vbCrLf & vbCrLf & "Room Information" & vbCrLf & vbCrLf & "Preferred Date: " & Request.Form("pdate") & vbCrLf & "Preferred Time: " & Request.Form("ptime")& vbCrLf & "Alternate Date: " & Request.Form("adate") & vbCrLf & "Alternate Time: " & Request.Form("atime") & vbCrLf & "Alternate Room? " & Request.Form("altroom")  & vbCrLf & vbCrLf & "Assignment Description: " & vbCrLf & vbCrLf & Request.Form("assignmentdesc") & vbCrLf & vbCrLf & "Citation Style: " & Request.Form("citationstyle") & vbCrLf & vbCrLf & "Instruction Package: " & vbCrLf & vbCrLf & "Package Selection: " & Request.Form("package") & vbCrLf & vbCrLf & "If Package Three Selected, Additional 25 Minutes: " & Request.Form("p3addon") & vbCrLf & vbCrLf & "If Custom Package Selected: " & Request.Form("custom")  & vbCrLf & vbCrLf & "Additional Information: " & Request.Form("other") & vbCrLf & "Individual Research Time - Number of minutes " & Request.Form("minutes")
				cdoMessage.Send
           ...
           <h2>Request Sent</h2>
                <p>Your instruction request has been sent. You will receive a confirmation email from library staff within two work days.</p>   
  ...
  <!-- ends footer -->
	<div id="updated">
		<span class="small_text">Last Updated:
              <!-- #BeginDate format:Am1 -->October 29, 2014<!-- #EndDate -->
